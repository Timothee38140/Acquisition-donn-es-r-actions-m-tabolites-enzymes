...
liste = []
test = pd.read_excel('/home/timotheerabot/Documents/stage_LBBE/Correspondances2.ods')
...
liste2 = []
test2 = pd.read_excel('/home/timotheerabot/Documents/stage_LBBE/correspondances3.ods')
