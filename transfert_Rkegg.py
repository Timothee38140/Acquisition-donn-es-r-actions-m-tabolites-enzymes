...
with open("/home/timotheerabot/Documents/acquisition_donnees/Acquisition-donn-es-r-actions-m-tabolites-enzymes/blend.txt", "r") as document_read:
    document = document_read.readlines()

for ligne in document:
    bouton = "off"
    liste_ligne = ligne.split(";")
    dico,dico2,dico3 = get_3_dicos(liste_ligne)
